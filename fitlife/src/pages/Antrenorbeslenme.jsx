...
const Antrenorbeslenme = ({ user: initialUser }) => {
  ...
  const handleBeslenmeSave = async () => {
    try {
      ...
      toast.success("Beslenme programı başarıyla kaydedildi.");
    } catch (error) {
      console.error("Beslenme programı kaydetme hatası", error);
      toast.error("Beslenme programı kaydetme hatası");
    }
  };

  return (
    <div>
      <h2>Beslenme Programı Hazırlama</h2>
      <div>
...
export default Antrenorbeslenme;
